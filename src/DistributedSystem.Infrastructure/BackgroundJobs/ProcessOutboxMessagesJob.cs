...
/**
    Cái job của mình đang chạy theo kiểu là async
    -> Rõ ràng là mình đang cấu hình là 100ms nó sẽ trigger cái job này 1 lần
    Giả sử cái job trước mình xử lí chưa thành công thì 100ms đấy xong thì nó sẽ trigger tạo 
    ra 1 cái instance của cái job này nữa -> tạo ra job duplicated 
    => để chặn được điều đó ta thêm att [DisallowConcurrentExecution] 
    => Ko cho phép tạo ra nhiều instance của thằng này
 */
